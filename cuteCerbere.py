...
from win32 import win32gui											#pour lire l'état courant de spotify
import win32ui, win32con, win32api
try:
	from pynput.keyboard import Key, Controller, Listener, KeyCode	#pour simuler l'utilisation des touches de son
except:
...
class mywindow(QtWidgets.QMainWindow):
	...
	def paramSon(self):
		self.ui.pushButton_changer_touche_son.setText("Taper sur\nla touche mute")
